...
{	
	...
	public class StrobeMediaPlayback extends Sprite
	{
		...
		protected function onLoadPlugin(event:MediaFactoryEvent):void {
			...
			trace("carregou!");
			if (ExternalInterface.available) { ExternalInterface.call('console.log', "carregooou!"); }
		}
		
		protected function onError(event:MediaFactoryEvent):void {
			trace("deu aguia!");
			if (ExternalInterface.available) { ExternalInterface.call('console.log', "deu aguia!"); }
		}
